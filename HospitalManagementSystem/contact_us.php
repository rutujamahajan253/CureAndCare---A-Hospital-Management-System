...
<body>
    <div>
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO `contactus` (`name`, `email`, `yquery`,`tuser`, `info`, `concern`, `date`) VALUES ('$name', '$email', '$yquery','$tuser', '$info', '$concern', current_timestamp())";
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #ffffff;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <!-- <div class="mx-2">
                    <div class="btn-group">
                        <button type="button" class="btn btn-success dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" data-bs-toggle="modal" data-bs-target="#loginModal">Login
                    </button>
    ...
    <div class="container my-4 mt-3">
        ...
        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
            ...
            <div class="form-group mt-3">
                <label for="exampleFormControlSelect1">Your Query Is About</label>
                <select class="form-control" id="exampleFormControlSelect1" name="yquery" required>
            ...
            <div class="form-group mt-3">
                <label for="exampleFormControlSelect2">Which one describes you the best?</label>
                <select class="form-control" id="exampleFormControlSelect2" name="tuser" required>
                    <option>Patient</option>
                    <option>Staff</option>
                </select>
            </div>
            <!-- <div class="form-group mt-3">
                <div class="col-sm-4">Which one describes you the best?</div>
                <div class="col-sm-10">

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="flexRadioDefault1" name="tuser" required>
                        <label class="form-check-label" for="flexRadioDefault1">
                            Patient
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="tuser" required id="flexRadioDefault2">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="info" required rows="3"></textarea>
                    </div>
                    <div class="form-group mt-2">
                        <label for="exampleFormControlTextarea2">Elaborate Your Concern</label>
                        <textarea class="form-control" id="exampleFormControlTextarea2" name="concern" required rows="3"></textarea>
                    </div>

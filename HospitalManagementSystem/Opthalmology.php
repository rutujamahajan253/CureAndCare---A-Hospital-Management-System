                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  Departments
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item active" href="Opthalmology.php">Ophthalmology</a></li>
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="Images/Opthalmology1.jpg" class="d-block w-100" height=500px; alt="...">
            </div>
            <div class="carousel-item">
                <img src="Images/Opthalmology2.jpg" class="d-block w-100" height=500px; alt="...">
            </div>
        </div>

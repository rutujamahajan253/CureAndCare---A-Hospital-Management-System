...
<div>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  Departments
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="Pathology.php">Pharmacy</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <div class="vertical-nav bg-white" id="sidebar">
        ...
        <ul class="nav flex-column bg-white mb-0 fs-6">
            <li class="nav-item">
                <a href="Admin_Profile.php" class="nav-link active text-dark" style="background-color:rgb(187, 187, 187);">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                <p class="text-muted mb-0"></p><?php echo $arr['address2']; ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                <p class="text-muted mb-0"></p><?php echo $arr['pincode']; ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">

...
<div>
        <?php
            if($_SESSION['status']==1 && $_SESSION['role'] == 'doctor')
            {
    ...
    <div class="vertical-nav bg-white" id="sidebar">
        ...
        <ul class="nav flex-column bg-white mb-0 fs-6">
            <li class="nav-item">
                <a href="Doctor.php" class="nav-link active text-dark" style="background-color:rgb(187, 187, 187);">
            ...
            <li class="nav-item">
                <a href="Upload_prescription.php" class="nav-link text-dark">
                    <i class="fa fa-cubes mr-3 text-primary fa-fw"></i> Upload Prescription
                </a>
            </li>
            <!-- <li class="nav-item">
                <a href="Emergency_Cases.php" class="nav-link text-dark">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"></p><?php echo $arr['mobilenumber']; ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"></p><?php echo $arr['gender']; ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">Your salary</p>
                                </div>
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"></p><?php echo $arr['salary']; ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">

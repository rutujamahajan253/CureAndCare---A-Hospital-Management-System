...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  Departments
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="patholohy.php">Pathology</a></li>
    ...
    <div class="vertical-nav bg-white" id="sidebar">
        ...
        <ul class="nav flex-column bg-white mb-0 fs-6">
            ...
            <li class="nav-item">
                <a href="View_Appointment.php" class="nav-link active text-dark" style="background-color:rgb(187, 187, 187);">
                    <i class="fa fa-address-card mr-3 text-primary fa-fw"></i> View Appointment
                </a>
            </li>
            <li class="nav-item">
                <a href="Upload_prescription.php" class="nav-link text-dark active">
    ...
    <div class="page-content p-5" id="content">
        ...
        <table class="table table-dark">
            ...
            <tbody>
                ...
                <?php
                $srno=1;
                $sql = "SELECT * FROM users1 WHERE done='1'";
                ...
                <tr class=" ">
                    <td><?php echo $srno ?></td>
                    <td><?php echo $arr['appid'];  ?></td>
                    <td><?php echo $arr['firstname'];  ?></td>
                    <td><?php echo $arr['lastname']; ?></td>
                    <td><?php echo $arr['inputAddress']; ?></td>
                    <td><?php echo $arr['inputCity']; ?></td>
                    <td><?php echo $arr['inputState']; ?></td>

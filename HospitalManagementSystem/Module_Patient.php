...
<body>
    ...
    <div class="vertical-nav bg-white" id="sidebar">
        ...
        <ul class="nav flex-column bg-white mb-0 fs-6">
            <li class="nav-item">
                <a href="Module_Patient.php" class="nav-link active text-dark" style="background-color:rgb(187, 187, 187);">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"></p><?php echo $arr['inputAddress']; ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"></p><?php echo $arr['inputAddress2']; ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"></p><?php echo $arr['inputCity']; ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"></p><?php echo $arr['inputState']; ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"></p><?php echo $arr['inputZip']; ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">

...
<body>
    <div>
        ...
        if (isset($_POST['submit'])) {
            ...
            if($_SESSION['status']==1 && $_SESSION['role']=='admin')
            {
            ...
            $sql = "INSERT INTO `recps` ( `recpid`,`firstname`, `lastname`, `email`, `password`, `address`, `city`, `state`, `mobileno`, `gender`, `salary`, `date`) VALUES ('$recpid','$firstname', '$lastname','$email', '$password' ,'$address', '$city', '$state', '$mobilenumber', '$gender','$salary',current_timestamp())";
    ...
    <div class="vertical-nav bg-white" id="sidebar">
        ...
        <ul class="nav flex-column bg-white mb-0 fs-6">
            ...
            <li class="nav-item">
                <a href="Admin_AddDoc.php" class="nav-link text-dark">
                    <i class="fa fa-address-card mr-3 text-primary fa-fw"></i> Add Doctor
                </a>
            </li>
            <li class="nav-item">
                <a href="Admin_AddRecp.php" class="nav-link active text-dark" style="background-color:rgb(187, 187, 187);">
    ...
    <div class="page-content p-5" id="content">
        ...
        <table class="table table-dark">
            ...
            <tbody>
                ...
                <?php
                $sql = "SELECT * FROM recps WHERE 1";
                $result = mysqli_query($conn, $sql);
                $num = mysqli_num_rows($result);
                $arr = mysqli_fetch_array($result);
                ?>
                <tr class=" ">
                <td><?php echo $arr['recpid'];  ?></td>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input class="btn btn-outline-success" type="submit" name="submit" value="Add Receptionist">
                                </div>
                            </div>
                        </div>
                    </div>

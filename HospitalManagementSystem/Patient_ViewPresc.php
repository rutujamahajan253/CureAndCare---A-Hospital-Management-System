...
<body>
    ...
    <div class="vertical-nav bg-white" id="sidebar">
        ...
        <ul class="nav flex-column bg-white mb-0 fs-6">
            ...
            <li class="nav-item">
                <a href="Patient_ViewPresc.php" class="nav-link active text-dark" style="background-color:rgb(187, 187, 187);">
    ...
    <div class="page-content p-5" id="content">
        ...
        if ($_SESSION['role'] == 'patient') {
            ...
            $sql = "SELECT * FROM users1 WHERE email='$emailid'";
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"></p><?php echo $arr['department']; ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"></p><?php echo $arr['doctor']; ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
        ...
        if (isset($_POST['view'])) {
            ...
            if ($_SESSION['role'] == 'patient') {
                ...
                if ($result) {
                    echo '<html><div class="alert alert-primary" role="alert">File Uploaded. </div></html>';
                } else {
                    echo '<html><div class="alert alert-danger" role="alert">File could not be uploaded.</div></html>';
                }
            }
        }
        ?>
                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="row" style="margin-bottom:20px">
                            <div class="col-sm-5">
                                <div class="col-sm-6">
                                    <h4 class="outline-success" value='View Prescription' name='view'>Your Prescription. </h4>
                                </div>
                                <div>
                                    <img src="Uploaded_prescription/<?= $arr['image'] ?>" alt="Prescription is not yet added.">
                                </div>
                            </div>
                        </div>
                    </div>
